...
<head>
  ...
  <link rel="stylesheet" href="../plugin/angulardemo/css/animate.css" type="text/css" />
  <link rel="stylesheet" href="../plugin/angulardemo/css/font-awesome.min.css" type="text/css" />
  <link rel="stylesheet" href="../plugin/angulardemo/css/simple-line-icons.css" type="text/css" />
  <link rel="stylesheet" href="../plugin/angulardemo/css/font.css" type="text/css" />
  <link rel="stylesheet" href="../plugin/angulardemo/css/app.css" type="text/css" />
</head>
<body>
    ...
    <div class="app-header navbar">
      ...
      <div class="navbar-header bg-dark">
        ...
        <a href="#/" class="navbar-brand text-lt">
          <i class="fa fa-btc"></i>
          <img src="plugin/angulardemo/img/logo.png" alt="." class="hide">
                ...
                <div class="list-group">
                  <a href class="media list-group-item">
                    <span class="pull-left thumb-sm">
                      <img src="plugin/angulardemo/img/a0.jpg" alt="..." class="img-circle">
                    </span>
          ...
          <li class="dropdown">
            <a href="#" data-toggle="dropdown" class="dropdown-toggle clear" data-toggle="dropdown">
              <span class="thumb-sm avatar pull-right m-t-n-sm m-b-n-sm m-l-sm">
                <img src="plugin/angulardemo/img/a0.jpg" alt="...">
            ...
            <div class="dropdown wrapper">
              <a ui-sref="app.page.profile">
                <span class="thumb-lg w-auto-folded avatar m-t-sm">
                  <img src="plugin/angulardemo/img/a0.jpg" class="img-full" alt="...">
                </span>
              </a>
      ...
      <div class="app-content-body fade-in-up">
        <!-- COPY the content from "tpl/" -->
          <div class="hbox hbox-auto-xs hbox-auto-sm">
            <div class="col">
              <div style="background:url(plugin/angulardemo/img/c4.jpg) center center; background-size:cover">
                <div class="wrapper-lg bg-white-opacity">
                  <div class="row m-t">
                    <div class="col-sm-7">
                      <a href class="thumb-lg pull-left m-r">
                        <img src="plugin/angulardemo/img/a0.jpg" class="img-circle">
                      </a>
                      <div class="clear m-b">
                ...
                <div class="streamline b-l b-info m-l-lg m-b padder-v">
                  <div>
                    <a class="pull-left thumb-sm avatar m-l-n-md">
                      <img src="plugin/angulardemo/img/a9.jpg" class="img-circle" alt="...">
                    </a>
                    <div class="m-l-lg">
                      <div class="m-b-xs">
                  ...
                  <div class="m-l-lg">
                    <a class="pull-left thumb-sm avatar">
                      <img src="plugin/angulardemo/img/a5.jpg" alt="...">
                    </a>          
                  ...
                  <div>
                    <a class="pull-left thumb-sm avatar m-l-n-md">
                      <img src="plugin/angulardemo/img/a3.jpg" alt="...">
                    </a>          
                  ...
                  <div>
                    <a class="pull-left thumb-sm avatar m-l-n-md">
                      <img src="plugin/angulardemo/img/a6.jpg" class="img-circle" alt="...">
                    </a>
                    <div class="m-l-lg m-b-lg">
                      ...
                      <div class="m-b">
                        ...
                        <img src="plugin/angulardemo/img/c5.jpg" class="b b-a wrapper-xs bg-white img-responsive">
                        <div class="m-t-sm">
                          <a href class="text-muted m-xs"><i class="icon-action-redo"></i></a>
                          <a href class="text-muted m-xs"><i class="icon-star"></i></a>
                          <a href class="text-muted m-xs"><i class="icon-refresh"></i> 13</a>
                  ...
                  <div>
                    <a class="pull-left thumb-sm avatar m-l-n-md">
                      <img src="plugin/angulardemo/img/a4.jpg" class="img-circle" alt="...">
                    </a>
                    <div class="m-l-lg m-b-lg">
                      <div class="m-b-xs">
                  ...
                  <div>
                    <a class="pull-left thumb-sm avatar m-l-n-md">
                      <img src="plugin/angulardemo/img/a2.jpg" alt="...">
                    </a>          
                  ...
                  <ul class="list-group no-bg no-borders pull-in">
                    <li class="list-group-item">
                      <a herf class="pull-left thumb-sm avatar m-r">
                        <img src="plugin/angulardemo/img/a4.jpg" alt="..." class="img-circle">
                    ...
                    <li class="list-group-item">
                      <a herf class="pull-left thumb-sm avatar m-r">
                        <img src="plugin/angulardemo/img/a5.jpg" alt="..." class="img-circle">
                        <i class="on b-white bottom"></i>
                      </a>
                      <div class="clear">
                    ...
                    <li class="list-group-item">
                      <a herf class="pull-left thumb-sm avatar m-r">
                        <img src="plugin/angulardemo/img/a6.jpg" alt="..." class="img-circle">
                    ...
                    <li class="list-group-item">
                      <a herf class="pull-left thumb-sm avatar m-r">
                        <img src="plugin/angulardemo/img/a7.jpg" alt="..." class="img-circle">
        ...
        <div class="row-row">
          <div class="cell">
            <div class="cell-inner padder">
              <!-- chat list -->
              <div class="m-b">
                <a href class="pull-left thumb-xs avatar"><img src="plugin/angulardemo/img/a2.jpg" alt="..."></a>
                <div class="clear">
              ...
              <div class="m-b">
                <a href class="pull-right thumb-xs avatar"><img src="plugin/angulardemo/img/a3.jpg" class="img-circle" alt="..."></a>
                <div class="clear">
